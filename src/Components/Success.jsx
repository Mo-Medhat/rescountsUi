        ...
        <section className='container m-auto'>
            <div className="flex flex-col items-center">
                ...
                <div className="w-11/12 sm:w-2/4 m-auto my-4 text-center">
                    ...
                    <p className='text-[#6B7280] text-[16px] leading-[21px] my-4 w-3/4 sm:w-full mx-auto'>Congratulations your password has been changed</p>
                    <div className="loginBtn">
                        <button
                        onClick={() => navigate('/login')}
                        className='text-[#ffffff] font-bold text-[18px] leading-[7px] bg-[#BEBEBE] p-5 rounded-[10px] w-full my-4 hover:bg-[#E9D023] hover:text-[#474746] transition'>Login</button>
                    </div>
                </div>
            </div>
        </section>
