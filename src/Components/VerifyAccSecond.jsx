        ...
        <section className='container m-auto'>
            <div className="flex flex-col items-center">
                ...
                <div className="w-11/12 sm:w-2/4 m-auto my-4 text-center">
                    ...
                    <IoIosCall className='w-[72px] h-[72px] text-[#E9D023] mx-auto'/>
                    </div>
                    <h3 className='text-[#374151] text-xl leading-9 font-medium'>Verify Account</h3>
                    <p className='text-[#6B7280] text-[16px] leading-[21px] my-4 w-3/4 sm:w-full mx-auto'>Please enter the verification code we sent To your Phone number 071*****12</p>
                    <div className="loginBtn">
                        <button
                        onClick={() => navigate('/activatedAccSecond')}
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <p className='text-[13px] leading-[15px] text-[#474746] underline'>Change Number</p>
                    </div>
                </div>
            </div>
        </section>
...
export default VerifyAccSecond